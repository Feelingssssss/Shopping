...
namespace Shopping_Shop
{
    public partial class DashBoard : Form
    {
        ...
        public DashBoard()
        {
            this.Icon = Shop_System.Properties.Resources.dashboard;
            InitializeComponent();
            GetItem();
            getInvoiceID();
        ...
        {
            Bitmap brm = Shop_System.Properties.Resources.Shoplogo;
            Image img = brm;
            ...
            // 
            Bitmap mutayyab = Shop_System.Properties.Resources.mutayyab;
